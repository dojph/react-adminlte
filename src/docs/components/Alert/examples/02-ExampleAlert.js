...
export default class ExampleAlert extends React.Component{
    ...
    render() {
        ...
        return (
            <div>
                <Alert iconClass='fa fa-info' type='alert-danger' onClose={this.handleDismiss} show={show}>
                    <h1>Warning!!</h1>
                    <p>
                ...
                {!show && <button className='btn btn-danger' onClick={this.handleShow}>Show Alert</button>}
            </div>
        );
    }
}